...
@NamedQueries({
    ...
    @NamedQuery(name = "Pregunta.findByPremio", query = "SELECT p FROM Pregunta p WHERE p.premio = :premio")
})
...
public class Pregunta implements Serializable {
    ...
    public Pregunta(Integer id, String preguntaCuestionario, String alternativauno, String alternativados, String alternativatres, String alternativacuatro, String respuesta, int premio) {
        this.id = id;
